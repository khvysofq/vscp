...
#ifndef TMQ_BASE_MESSAGEQUEUE_H_
#define TMQ_BASE_MESSAGEQUEUE_H_
...
namespace tmq {
  ...
  public:
    ...
    const boost::scoped_ptr<T>& data() const { return data_; }
    boost::scoped_ptr<T>& data() { return data_; }
  private:
  ...
  //  const boost::scoped_refptr<T>& data() const { return data_; }
  //  boost::scoped_refptr<T>& data() { return data_; }
  //private:
  //  boost::scoped_refptr<T> data_;
  //};
  ...
  public:
    ...
    // no longer be used.
    boost::signals2::signal<void(void)> SignalQueueDestroyed;
...
#endif  // TMQ_BASE_MESSAGEQUEUE_H_
