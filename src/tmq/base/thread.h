...
#ifndef TMQ_BASE_THREAD_H_
#define TMQ_BASE_THREAD_H_
...
class Thread : public MessageQueue {
 public:
  ...
  // method, like derived implementation of tmq::Thread and it can not be
...
class SocketServerScope : public boost::noncopyable {
 public:
