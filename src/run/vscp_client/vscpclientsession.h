...
private:
  ...
  void OnClientLogined(VscpBaseSession* vscp_session, const Vsid& remote_vsid);
  void OnClientLogout(VscpBaseSession* vscp_session,
    const Vsid& remote_vsid);
  void OnSessionVscpData(VscpBaseSession* vscp_session,
